...
object PreviewData {
    val mockSequences = persistentListOf(
        Sequence(
            ...
            ipv = null, ttl = null, localPort = null, uri = null, group = null,
            checkAccess = false, checkType = CheckAccessType.URL, checkPort = null, checkHost = null,
            checkTimeout = 3, checkPostKnock = false, checkRetries = 1
        ),
        Sequence(
    ...
    val mockGroupedSequences = persistentMapOf(
        "Group 1" to mockSequences
    )
    val mockLogEntries = listOf(
        LogEntry(
            id = 1,
